...
<!--    <div class="Index" @drop.prevent="dropFile" @dragover.prevent>
        <el-container>
            ...
            <el-aside width="240px">
                <div class="asideHeader">
                    <div class="logo"><img src="../../../assets/disk/img/logo.png" alt=""/></div>
                    <div class="name">小破盘</div>
                </div>
                <AsideBar :asideBarData="asideBarData"></AsideBar>
            </el-aside>
            <el-main>
        ...
        &lt;!&ndash; 视频播放组件 &ndash;&gt;
        &lt;!&ndash;        <video-player></video-player>
                &lt;!&ndash; 音频播放组件 &ndash;&gt;
                <music-player></music-player>&ndash;&gt;
        &lt;!&ndash; 上传进度条提示框 &ndash;&gt;
        <progress-dialog></progress-dialog>
        &lt;!&ndash; 用于下载的a标签 &ndash;&gt;
        <a
...
/*import AsideBar from "@/components/disk/asideBar/AsideBar";
import UserInfoCard from "@/components/disk/userInfoCard/UserInfoCard.vue";
import VideoPlayer from "@/components/disk/videoPlayer/VideoPlayer.vue";
import MusicPlayer from "@/components/disk/musicPlayer/MusicPlayer.vue";
import ProgressDialog from "@/components/disk/progressDialog/ProgressDialog.vue";*/

const asideBarData = reactive([
    {
        path: "/files",
        name: "文件",
        icon: "wenjian",
...
const downloadFileInfo = reactive({
    name: "",
    url: "",
})
...
// 请求
// 上传至数据库的请求
const  updateToSQL = async (data, fileName) => {
...
// 点击下载文件的回调
const downloadCurrentFile = (name, url) => {
